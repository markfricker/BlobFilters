...
and then filtered with the compact 3{\x}3 discrete Laplacian
...
\marginnote{%
  ...
  Number of angles in $[0°,180°)$. Default \texttt{12}.
  \medskip\par
  \textbf{\texttt{mode}} \newline
...
\marginnote{%
  ...
  \medskip\par
  \textbf{\texttt{orientations}} \newline
  Number of angles in $[0°,180°)$. Default \texttt{8}.
  \medskip\par
...
\marginnote{%
  ...
  \medskip\par
  \textbf{\texttt{orientations}} \newline
  Discrete angles in $[0°,180°)$. Default \texttt{8}.
  \medskip\par
